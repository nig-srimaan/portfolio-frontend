            ...
            <div className={styles.content}>
              <div className={styles.contactItem}>
                ...
                <div>
                  ...
                  <a href="mailto:srimaan@example.com" className={styles.contactValue}>srimaan@example.com</a>
                </div>
              </div>
              <div className={styles.contactItem}>
                ...
                <div>
                  ...
                  <a href="https://linkedin.com/in/srimaan" target="_blank" rel="noreferrer" className={styles.contactValue}>linkedin.com/in/srimaan</a>
                </div>
              </div>
              <div className={styles.contactItem}>
                ...
                <div>
                  ...
                  <a href="https://github.com/srimaan" target="_blank" rel="noreferrer" className={styles.contactValue}>github.com/srimaan</a>
                </div>
              </div>
            </div>
          </motion.div>
